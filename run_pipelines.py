...
class Pipelines:
    ...
    def mnist_svhn_mix_pipeline(self):
        ...
        model = train.train_pipeline(epochs=self.epochs, k_fold=k_fold, batch_size=self.batch_size,
                                     train_dataset=train_dataset, lr=self.lr, computing_device=self.device,
    ...
    def mnist_svhn_pipeline(self):
        ...
        model = train.train_pipeline(epochs=self.epochs, k_fold=k_fold, batch_size=self.batch_size,
                                     train_dataset=train_dataset, lr=self.lr, computing_device=device,
                                     num_workers=self.num_workers, model=self.model())
...
if __name__ == '__main__':
    ...
    #We only want the mix pipeline with non siamese model
